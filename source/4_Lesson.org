...
- The other member of the pair should operate the adder. You should eb able to perform this without speaking.
...
- Create a new Python script using you're prefered text-editor or IDE (probably IDLE)
